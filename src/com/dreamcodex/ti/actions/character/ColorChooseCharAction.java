...
public class ColorChooseCharAction extends EditorAction {

    private final int index;

    public ColorChooseCharAction(int index, String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
