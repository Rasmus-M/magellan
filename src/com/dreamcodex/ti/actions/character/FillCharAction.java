...
public class FillCharAction extends EditorAction {

    public FillCharAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
