...
public class RotateRightCharAction extends EditorAction {

    public RotateRightCharAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
