...
public class FlipHorizontalCharAction extends EditorAction {

    public FlipHorizontalCharAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
