...
public class ColorForeCharAction extends EditorAction {

    private final int index;

    public ColorForeCharAction(int index, String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
    ...
    protected void performAction(ActionEvent e) {
        ...
        if (colorMode == COLOR_MODE_GRAPHICS_1 || colorMode == COLOR_MODE_BITMAP) {
            ...
            parent.getUI().getCharColorDockButtons()[index].setText("F");
            ...
            if ((e.getModifiers() & (ActionEvent.SHIFT_MASK | KeyEvent.CTRL_MASK)) == 0) {
                ...
                int index2 = parent.getUI().getCharECMPaletteComboBox().getIndexBack();
