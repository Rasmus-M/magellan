...
public class ShiftRightSpriteAction extends EditorAction {

    public ShiftRightSpriteAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
