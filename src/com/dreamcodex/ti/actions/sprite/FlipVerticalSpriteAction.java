...
public class FlipVerticalSpriteAction extends EditorAction {

    public FlipVerticalSpriteAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
