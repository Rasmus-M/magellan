...
public class RotateRightSpriteAction extends EditorAction {

    public RotateRightSpriteAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
