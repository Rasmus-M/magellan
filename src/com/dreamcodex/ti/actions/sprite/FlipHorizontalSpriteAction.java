...
public class FlipHorizontalSpriteAction extends EditorAction {

    public FlipHorizontalSpriteAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
