...
public class ClearSpriteAction extends EditorAction {

    public ClearSpriteAction(String name, Magellan parent, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
