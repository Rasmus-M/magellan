...
public abstract class MagellanAction extends AbstractAction {
    ...
    protected final IconProvider iconProvider;
    protected final MapEditor mapEditor;
    protected final DataSet dataSet;
    protected final Preferences preferences;

    public MagellanAction(String name, JFrame parent, IconProvider iconProvider, MapEditor mapEditor, DataSet dataSet, Preferences preferences) {
        super(name);
        this.parent = parent;
